...
def update_8gen():
    ...
    csv_url = "https://docs.google.com/spreadsheets/d/1IH8rDfDMATG-nnQ7B0HexoIR0B2J152muONxLi1KE9M/export?format=csv&gid=1263444020"
    ...
    print(f"Added/Updated {added_count} 8th generation Pokemon to the pokedex.")
